...
export function NotificationBell({ enabled }: { enabled: boolean }) {
	...
	return <Sheet onOpenChange={setOpen} open={open}>
		...
		<SheetContent aria-describedby='notification-description' className='notification-sheet'>
			...
			{notifications.error && !status ? <div className='notification-sheet__state' role='alert'>Notifications are temporarily unavailable. <button onClick={() => notifications.refetch()} type='button'>Try again</button></div> : null}
